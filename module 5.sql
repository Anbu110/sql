...
AS
BEGIN
	SELECT emp.EmployeeId,dbo.fn_GetEmployeeFullName1(employeeFirstName,employeeLastName) AS FullName
				,Address,EmployeeDOB
...
BEGIN
	...
	SELECT EmployeeId,dbo.fn_GetEmployeeFullName1(EmployeeFirstName,EmployeeLastName) AS FullName
